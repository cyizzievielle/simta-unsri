...
<div class="page-hero">
    ...
    <p>Tinjau judul aktif dari mahasiswa bimbingan dan lanjutkan ke halaman detail untuk memberi review.</p>
</div>
...
<div class="card-premium">
    <div class="section-head">
        <div>
            ...
            <p class="section-subtitle-premium">Hanya pengajuan berstatus diajukan atau direview yang tampil di sini.</p>
        </div>
    </div>
                ...
                <tbody>
                    <?php foreach ($pengajuanAktif as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('/dosen/pengajuan-judul/detail/' . (string) ($row['id'] ?? '')) ?>" class="btn btn-primary" style="padding:10px 14px;">
                                    Lihat Detail
                                </a>
                            </td>
                        </tr>
