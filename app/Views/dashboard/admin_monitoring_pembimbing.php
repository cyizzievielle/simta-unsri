...
<?php
    ...
    $buildPageUrl = static function (int $targetPage) use ($queryParams) {
        ...
        return base_url('/admin/monitoring-pembimbing?' . http_build_query($params));
    };
?>
...
<div class="card-premium">
    ...
    <p class="section-subtitle-premium">Cari, filter, dan pantau status permohonan pembimbing mahasiswa dalam satu tabel yang rapi.</p>

    <div class="filter-wrap">
        <form method="get" action="<?= base_url('/admin/monitoring-pembimbing') ?>">
            <div class="filter-grid">
                <div class="form-group-premium">
                    <label for="q">Cari Mahasiswa / NIM / Dosen</label>
                ...
                <div class="filter-actions">
                    ...
                    <a href="<?= base_url('/admin/monitoring-pembimbing') ?>" class="btn" style="border:1px solid #cbd5e1; color:#334155;">Reset</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <?php else: ?>
        <div class="premium-empty">Belum ada data monitoring pembimbing yang cocok dengan filter.</div>
    <?php endif; ?>
