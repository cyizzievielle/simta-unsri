...
<?php
    ...
    foreach ($proposalAktif as $row) {
        ...
        if ($status === 'diajukan') $totalDiajukan++;
        if ($status === 'direview') $totalDireview++;
    }
...
<div class="premium-stats">
    <div class="premium-stat-card stat-blue">
        <div class="premium-stat-label">Total Proposal Aktif</div>
...
<div class="card-premium">
    <div class="section-head">
        <div>
            ...
            <p class="section-subtitle-premium">Hanya proposal berstatus diajukan atau direview yang tampil di sini.</p>
        </div>
    </div>

    <?php if (! empty($proposalAktif)): ?>
                ...
                <tbody>
                    <?php foreach ($proposalAktif as $row): ?>
                        <tr>
                            ...
                            <td>
                                <div class="cell-title"><?= esc((string) ($row['judul'] ?? '-')) ?></div>
                            </td>
                            <td>
                                <div class="cell-title"><?= esc((string) (($row['nama_file_asli'] ?? '') !== '' ? $row['nama_file_asli'] : '-')) ?></div>
                                <div class="cell-sub">
                            ...
                            <td>
                                <a href="<?= base_url('/dosen/proposal-ta/detail/' . (string) ($row['id'] ?? '')) ?>" class="btn btn-primary" style="padding:10px 14px;">
                                    Lihat Detail
                                </a>
                            </td>
                        </tr>
